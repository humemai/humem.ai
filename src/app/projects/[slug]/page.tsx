...
import { EditorialBenchmarkTable, EditorialFigureGrid, EditorialLinkSection, EditorialSection, EditorialSectionFigure } from "@/components/editorial-sections";
...
export default async function ProjectDetailPage({ params }: { params: Promise<Params> }) {
  ...
  const renderEditorialBodyBlock = (sectionId: string, block: ProjectEditorialBodyBlock, index: number) => {
    ...
    if (block.type === "benchmarkTable") {
      const table = arcadeDbBenchmarks.tables.find((candidate) => candidate.id === block.tableId);
      ...
      // let the build-time check below be the thing that complains.
      if (!table) {
        return null;
      }
