    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "| Engine | License | OSI-approved |\n| --- | --- | --- |\n| ArcadeDB engine | Apache-2.0 | yes |\n| arcadedb-embedded (the Python package) | Apache-2.0 | yes |\n| PostgreSQL and pgvector | PostgreSQL License | yes |\n| Apache AGE | Apache-2.0 | yes |\n| DuckDB | MIT | yes |\n| SQLite | public domain | not a license (free for any use) |\n| sqlite-vec | Apache-2.0 or MIT | yes |\n| MongoDB Community | SSPL-1.0 | no |\n| Neo4j Community | GPL-3.0 (Enterprise is commercial) | yes |\n| LadybugDB | MIT | yes |\n| Qdrant | Apache-2.0 | yes |\n| Milvus | Apache-2.0 | yes |\n| Elasticsearch | AGPL-3.0 (also offered under SSPL and ELv2) | yes under AGPL |\n| Chroma | Apache-2.0 | yes |\n| LanceDB | Apache-2.0 | yes |\n| QuestDB | Apache-2.0 | yes |\n| TimescaleDB | Apache-2.0 core with the Timescale License for the features the image ships | partly |\n| SurrealDB | Business Source License 1.1 (the SDK is Apache-2.0) | no |",
          "Checked against each project's repository at the pinned version in September 2026; a license can change with a release.",
        ],
      },
    ],
  },
