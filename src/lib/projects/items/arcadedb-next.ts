  ...
  subprojectPage: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "Graph is what most people use ArcadeDB for. The benchmark is LDBC-SNB, the Linked Data Benchmark Council's Social Network Benchmark. Each engine is asked in the language it is normally asked in: ArcadeDB, Neo4j, Memgraph, FalkorDB and LadybugDB answer in Cypher, DuckPGQ in SQL/PGQ, ArangoDB in AQL, SurrealDB in SurrealQL, and MongoDB in an aggregation pipeline. ArcadeDB has its own SQL and is asked in Cypher here anyway, deliberately: how close its Cypher comes to its SQL is part of what this table is for, so the difference between them belongs in the measurement rather than outside it. Neo4j is the comparator most readers will want; LadybugDB is here because it is embedded and columnar, which is the closest thing to running ArcadeDB inside your own process.",
