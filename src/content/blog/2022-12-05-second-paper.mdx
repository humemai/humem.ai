...
date: '2022-12-05'
image: '/blog/2022-12-05/q-network-diagram.png'
...
Our first HumemAI research paper, [A Machine with Human-Like Memory Systems](/blog/first-paper), did not use machine learning. Instead, all memory management policies were handcrafted. While these handcrafted functions worked well, they lacked adaptability to new environments. 
